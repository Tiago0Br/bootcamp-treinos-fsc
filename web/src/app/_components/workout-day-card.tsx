import { CalendarIcon, DumbbellIcon, TimerIcon } from 'lucide-react'
import Image from 'next/image'
import type { GetHomeData200TodayWorkoutDayWeekDay } from '@/lib/api/fetch-generated'
    ...
    <div className="relative flex h-50 w-full flex-col items-start justify-between overflow-hidden rounded-xl p-5">
      ...
      <div className="relative">
        <div className="flex items-center gap-1 rounded-full bg-background/16 px-2.5 py-1.5 backdrop-blur-sm">
          <CalendarIcon className="size-3.5 text-background" />
      ...
      <div className="relative flex flex-col gap-2">
        ...
        <div className="flex items-start gap-2">
          <div className="flex items-center gap-1">
            <TimerIcon className="size-3.5 text-background/70" />
            <span className="font-heading text-xs text-background/70">
              {durationInMinutes}min
            </span>
          </div>
          <div className="flex items-center gap-1">
            <DumbbellIcon className="size-3.5 text-background/70" />
            <span className="font-heading text-xs text-background/70">
