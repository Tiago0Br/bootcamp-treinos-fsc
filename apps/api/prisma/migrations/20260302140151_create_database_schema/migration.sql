...
-- AddForeignKey
ALTER TABLE "workout_exercices" ADD CONSTRAINT "workout_exercices_workout_day_id_fkey" FOREIGN KEY ("workout_day_id") REFERENCES "workout_days"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
